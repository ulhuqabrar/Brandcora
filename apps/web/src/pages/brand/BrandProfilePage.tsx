      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Button asChild className="gradient-accent text-white shadow-glass">
            <Link to="/brand/extract"><Globe className="mr-1.5 h-4 w-4" weight="bold" />Extract from website</Link>
          </Button>
          {!editing && (
        ...
        <>
          {profile.websiteUrl && (
            <div className="glass-strong rounded-2xl p-4 shadow-glass flex items-center gap-3">
              ...
              <Button size="sm" variant="ghost" asChild><Link to="/brand/extract">Re-extract<ArrowRight className="ml-1 h-3 w-3" weight="bold" /></Link></Button>
            </div>
          )}
