      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border">
        <div className="mx-auto max-w-[1200px] flex items-center justify-between px-6 lg:px-8 h-16">
          ...
          <div className="flex items-center gap-3">
            <Link to="/login" className="text-sm text-foreground-secondary hover:text-foreground transition-colors hidden sm:block">Log in</Link>
            <Link to="/register">
        ...
        <div className="mx-auto max-w-[1200px] flex flex-col md:flex-row items-center justify-between gap-6">
          <Link to="/" className="flex items-center gap-2.5">
            <div className="h-6 w-6 rounded-md gradient-accent flex items-center justify-center">
              <span className="text-white text-[10px] font-bold">BG</span>
            </div>
            <span className="text-sm font-bold text-foreground tracking-tight">Brandcora</span>
          </Link>
          ...
          <span className="text-sm text-foreground-muted">
            &copy; {new Date().getFullYear()} Brandcora
          </span>
        </div>
      </footer>
    </div>
