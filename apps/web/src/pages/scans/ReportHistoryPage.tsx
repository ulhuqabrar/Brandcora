      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button asChild className="gradient-accent text-white shadow-glass">
            <Link to="/scans/new-social"><Plus className="mr-1.5 h-4 w-4" weight="bold" />New social check</Link>
          </Button>
          <Button variant="outline" asChild>
            <Link to="/scans/new-website">New website check</Link>
          </Button>
        </div>
      </div>
        ...
        <div className="glass-strong rounded-2xl p-8 shadow-glass">
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <div className="flex gap-3 mt-4">
              <Button asChild className="gradient-accent text-white shadow-glass">
                <Link to="/scans/new-social">Social check</Link>
              </Button>
              <Button variant="outline" asChild>
                <Link to="/scans/new-website">Website check</Link>
              </Button>
            </div>
          </div>
        </div>
