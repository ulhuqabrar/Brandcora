    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button asChild className="gradient-accent text-white shadow-glass">
            <Link href="/scans/new-social"><Plus className="mr-1.5 h-4 w-4" weight="bold" />Run another check</Link>
          </Button>
          <Button variant="outline" asChild className="glass">
            <Link href="/dashboard"><ArrowLeft className="mr-1.5 h-4 w-4" weight="bold" />Back</Link>
          </Button>
        </div>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <Button variant="outline" asChild>
          <Link href="/scans">View all reports</Link>
        </Button>
      </div>
    </div>
  );
